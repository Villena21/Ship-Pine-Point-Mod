...
define config.name = _("Pine Point: Insomniac (Love version)")
...
define config.main_menu_music = "shadow - warmth.mp3"
...
define config.save_directory = "PinePoint-1728590836"
